...
# Define the list of entities to recognize
ENTITY_LIST = ['PER']
...
class BanglaNerSpacy:
    ...
    def model_pediction(self, model, sentence):
        """
        Perform model prediction on a given sentence.
        """
        doc = model(sentence)
        return doc
...
class SeqEvalEvaluation:
    ...
    def performance_calculation(self, gt_labels, pt_labels):
        """
        Calculate performance metrics using seqeval.
        """
...
if __name__ == "__main__":
    ...
    """
    For custom span based evaluation, GT data format (JSONL) looks like:
